...
| Strict SunPad overlay/menu/touch parity | Overlay/settings/mixer/input/mapping sources byte-identical; diagnostics differs only by app log root; UI renders on iPad Simulator | **Source parity proven; interaction partial** | Current-build touch/menu/editor tests on iPhone + iPad and physical devices |
...
| Diagnostics and Share Diagnostic Log | SunPad persistent rotating/redacted log and share UI are ported | **Implementation present, UI unverified** | Trigger confirmation/snapshot/share sheet, inspect redaction and shared artifact on iPhone/iPad/device |
...
| iPhone layout | Universal app declares iPhone support | **Not yet tested** | iPhone Simulator screenshots/interactions, then physical iPhone |
